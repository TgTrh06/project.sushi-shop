...
import { SeatHoldModel, type SeatHoldDocument } from "@/modules/reservations/infrastructure/mongoose/seat-hold.model";
import { getSessionById } from "@/modules/reservations/domain/config/reservation.config";
