...
import { MongooseSessionRepository } from "@/modules/auth/infrastructure/mongoose/session.repository";
...
import { MongooseCategoryRepository } from "@/modules/categories/infrastructure/mongoose/category.repository";
...
import { CategoryController } from "@/modules/categories/presentation/http/category.controller";
import { MongooseProductRepository } from "@/modules/products/infrastructure/mongoose/product.repository";
...
import { ProductController } from "@/modules/products/presentation/http/product.controller";
import { MongooseReviewRepository } from "@/modules/reviews/infrastructure/mongoose/review.repository";
...
import { ReviewController } from "@/modules/reviews/presentation/http/review.controller";
...
import { UploadController } from "@/modules/uploads/presentation/http/upload.controller";
import { MongooseStatsRepository } from "@/modules/stats/infrastructure/mongoose/stats.repository";
import { GetSystemStatsUseCase } from "@/modules/stats/application/use-cases/get-system-stats.use-case";
import { StatsController } from "@/modules/stats/presentation/http/stats.controller";
import { MongooseReservationRepository } from "@/modules/reservations/infrastructure/mongoose/reservation.repository";
import { MongooseSeatHoldRepository } from "@/modules/reservations/infrastructure/mongoose/seat-hold.repository";
...
import { ReservationController } from "@/modules/reservations/presentation/http/reservation.controller";
import { MongoosePaymentSettingsRepository, MongooseReservationPaymentRepository } from "@/modules/payments/infrastructure/mongoose/payment.repository";
...
import { PaymentSettingsController } from "@/modules/payments/presentation/http/payment-settings.controller";
